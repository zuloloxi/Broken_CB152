...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	#cs
		...
		EndIf
		If $ichkUpgrade5 = 1 Then
		GUICtrlSetState($chkUpgrade5, $GUI_CHECKED)
		Else
		GUICtrlSetState($chkUpgrade5, $GUI_UNCHECKED)
		EndIf
		If $ichkUpgrade6 = 1 Then
		GUICtrlSetState($chkUpgrade6, $GUI_CHECKED)
		Else
		GUICtrlSetState($chkUpgrade6, $GUI_UNCHECKED)
		EndIf
	#ce
	#cs
		...
		GUICtrlSetData($txtUpgradeX5, $itxtUpgradeX5)
		GUICtrlSetData($txtUpgradeY5, $itxtUpgradeY5)
		GUICtrlSetData($txtUpgradeX6, $itxtUpgradeX6)
		GUICtrlSetData($txtUpgradeY6, $itxtUpgradeY6)
	#ce
	;General Settings--------------------------------------------------------------------------
