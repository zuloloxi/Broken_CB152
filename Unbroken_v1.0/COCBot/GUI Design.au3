...
$txtLog = _GUICtrlRichEdit_Create($frmBot, "", 16, 40, 385, 230, BitOR($ES_MULTILINE, $ES_READONLY, $WS_VSCROLL, $WS_HSCROLL, 8912))
...
$chkNoAttack = GUICtrlCreateCheckbox("Donate/Train Only", 24, 330, 105, 17)
...
$chkDonateOnly = GUICtrlCreateCheckbox("Donate Only", 140, 330, 80, 17)
GUICtrlSetBkColor($chkDonateOnly, $COLOR_WHITE)
GUICtrlSetOnEvent(-1, "chkNoAttack")
GUICtrlSetState(-1, $GUI_UNCHECKED)
GUICtrlSetTip(-1, "Disable attacking & training, only do collections/donating")

$lblMaxTrophy = GUICtrlCreateLabel("Trophy Range:", 232, 331, 75, 17)
$txtMinimumTrophy = GUICtrlCreateInput("1000", 311, 331, 32, 16, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 4)
$lblMaxTrophy2 = GUICtrlCreateLabel("-", 349, 331, 5, 17)
$txtMaxTrophy = GUICtrlCreateInput("9999", 360, 331, 32, 16, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 4)
...
GUICtrlSetTip(-1, "Request for input.")
$gtfo = GUICtrlCreateCheckbox("GTFO", 341, 70, 50, 17) ;==> add this
...
;Load/Save Function
$pageConfigLoadSave = GUICtrlCreateTabItem("Configurations")
$ConfigLoadSave = GUICtrlCreateGroup("Config Load/Save", 24, 40, 129, 113)
$btnLoad = GUICtrlCreateButton("Load", 40, 64, 97, 25)
GUICtrlSetOnEvent(-1, "btnLoad")
$btnSave = GUICtrlCreateButton("Save", 40, 96, 97, 25)
GUICtrlSetOnEvent(-1, "btnSave")
$lblConfig = GUICtrlCreateLabel(getfilename($config), 40, 128, 92, 17, $SS_CENTER)
GUICtrlCreateGroup("", -99, -99, 1, 1)
