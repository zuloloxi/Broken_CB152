...
$txtLog = _GUICtrlRichEdit_Create($frmBot, "", 16, 40, 385, 205, BitOR($ES_MULTILINE, $ES_READONLY, $WS_VSCROLL, $WS_HSCROLL, 8912))
...
$grpUpdate = GUICtrlCreateGroup("Auto Update", 20, 205, 375, 60)
$chkUpdate = GUICtrlCreateCheckbox("Check GitHub site for updates on launch", 40, 230, 300, 15)
GUICtrlSetBkColor($chkUpdate, $COLOR_WHITE)
GUICtrlSetState(-1, $GUI_UNCHECKED)

$grpBluestacks = GUICtrlCreateGroup("BlueStacks", 20, 275, 375, 80)
$chkBackground = GUICtrlCreateCheckbox("Background Mode", 40, 300, 105, 15)
GUICtrlSetBkColor($chkBackground, $COLOR_WHITE)
GUICtrlSetOnEvent(-1, "chkBackground")
GUICtrlSetState(-1, $GUI_UNCHECKED)
GUICtrlSetTip(-1, "Activate Background Mode")
$chkForceBS = GUICtrlCreateCheckbox("Force Active", 40, 320, 105, 15)
